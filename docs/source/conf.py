...
# transformers_match documentation build
...
from sentence_transformers import __version__ as release

# -- Project information -----------------------------------------------------

project = "transformers_match"
author = "Elian"
...
htmlhelp_basename = "transformers_matchdoc"
...
latex_documents = [
    (
        master_doc,
        "transformers_match.tex",
        "transformers_match Documentation",
        "Elian",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "transformers_match",
        "Project transformers_match codebase.",
        "Nearest-Neighbour",
    )
]
